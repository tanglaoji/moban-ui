<template>
  <mo-header height="76px">
    ...
    <div class="flex-ver-c">
      <div class="flex-ver-c">
        <a class="npm" href="https://www.npmjs.com/package/moban-ui" target="_blank">
          <svg t="1638626343486" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3286"
            width="20" height="20">
            <path d="M0 0v1024h1024V0H0z m832 832h-128V320h-192v512H192V192h640v640z" p-id="3287"></path>
          </svg>
        </a>
        <a class="gitee" href="https://gitee.com/tanglaoji/moban-ui" target="_blank">
          <svg t="1638625752185" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2479"
            width="21" height="21">
            <path
        ...
        <a class="git" href="https://github.com/tanglaoji/moban-ui" target="_blank">
          <svg t="1638625394435" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2313"
            width="24" height="24">
            <path
      ...
      <div class="flex-ver-c">
        ...
        <text-switch left-text="中文" right-text="EN" @change="handleSwitchLanguage" />
      </div>
    </div>
  </mo-header>
</template>
...
export default {
  ...
  methods: {
    handleSwitchLanguage(val) {
      this.$i18n.locale = val ? "zh_CN" : "en_US";
    }
  }
};
</script>
